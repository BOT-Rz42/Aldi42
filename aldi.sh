...
echo -e  "Tools    : Aldi Suwandi Putra $red         " |lolcat
echo -e  "Creadby  : Aldi $gold   " |lolcat
echo -e  "Contact  : JPT Official $white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : Aldi Suwandi Putra" | lolcat
exit
;;
